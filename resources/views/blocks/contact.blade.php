...
<section data-gsap-anim="section" class="contact -spt {{ $sectionClass }}">
	...
	<div class="__wrapper c-main-wide relative z-2">
		<h2 class="flex __before m-title w-1/2">{!! $g_contact_1['title'] !!}</h2>
	...
	<svg class="absolute top-0 right-0 z-1" xmlns="http://www.w3.org/2000/svg" width="928" height="1098" viewBox="0 0 928 1098" fill="none">
